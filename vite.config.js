  ...
  plugins: [
    ...
    viteStaticCopy({
      targets: [
        ...
        {
          src: ['sitemap.xml', 'sitemap.html', 'robots.txt', 'favicon.ico', 'favicon.svg', 'manifest.json', 'site.webmanifest', 'blog-data.js', 'cta_counter.json', 'privacy.html', 'bc5ada97a10c8516596ea24189a7452a.txt', 'feed.xml'],
          dest: '.'
        }
      ]
    }),
