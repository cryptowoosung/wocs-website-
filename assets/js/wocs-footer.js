...
function buildFloatingCTA() {
  ...
  div.id = 'floating-cta';
  div.innerHTML = `
    <a href="tel:01043370582" class="float-btn float-btn-gold" title="전화 문의" style="bottom:24px;right:24px;position:fixed;z-index:998">✆</a>
